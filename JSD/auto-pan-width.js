...
slider15:-240<-240,0,0.01>Detected threshold (dB)

slider1:-32<-120,0,0.25>Open threshold (dB)
slider2:-32<-120,0,0.25>Close threshold (dB)
slider3:250<0,1000,.1>Attack time
...
slider9:3<-24,24,0.5>Boost gain (dB)
